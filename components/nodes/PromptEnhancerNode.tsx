...
export const PromptEnhancerNode: React.FC<PromptEnhancerNodeProps> = ({ content, status, onUpdate, onRun }) => {
    ...
    <div className="flex flex-col gap-4 min-h-[300px]">
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <button 
          ...
          className="flex items-center gap-2 rounded-xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 px-6 py-2.5 text-[13px] font-bold text-gray-200 transition-all active:scale-95 disabled:opacity-50"
        >
